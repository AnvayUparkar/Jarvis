...
try:
    ...
    print(f"❌ Error configuring Gemini API in google_forms_integration.py: {e}. Please check your GEN_AI_API_KEY.")
...
def generate_options_with_gemini(form_topic: str, question_text: str, speak_func=None):
    ...
    try:
        ...
        print(f"✅ Gemini generated options: {options_list}")
        return options_list
    except json.JSONDecodeError as e:
        print(f"❌ Error parsing JSON from Gemini for options: {e}. Response: {response.text}")
        speak_func("I had trouble understanding the options generated by AI.")
        return []
    except Exception as e:
        print(f"❌ An unexpected error occurred with Gemini during option generation: {e}")
...
def create_google_form(form_title: str, form_description: str, questions_data: list, speak_func=None, form_topic: str = "", get_credentials_func=None, all_scopes=None):
    ...
    if get_credentials_func is None:
        ...
        print("❌ Authentication function not provided. Cannot create form.")
        return None
    ...
    if not creds:
        ...
        print("❌ Failed to get Google Forms credentials. Cannot create form.")
        return None
    ...
    if not all(s in creds.scopes for s in required_forms_scopes):
        ...
        print("❌ Forms API scopes missing from authenticated credentials. Re-authentication with correct scopes is needed.")
        return None
    ...
    try:
        ...
        if requests:
            ...
            print(f"✅ Added {len(questions_data)} questions and description to the form.")
        else:
        ...
        print(f"❌ Google Forms API Error: {err}")
        ...
        print(f"❌ An unexpected error occurred while interacting with Google Forms: {e}")
        return None
